...
namespace WorkoutDBObject
{
    public class SwimWorkoutDBContext
    {
        ...
        public static WorkoutPlanObject getWorkoutPlan(int planid)
        {
            ...
            conn.Open();
                ...
                try
                {
                    ...
                    SqlDataReader reader = SqlHelper.ExecuteReader(conn, "getworkoutplan", planid);
        ...
        public static long insertWorkoutPlan(WorkoutPlanObject plan)
        {
            ...
            using (SqlTransaction trans = conn.BeginTransaction())
            {
                ...
                {   // insert and retrieve plan id
                    ...
                    plan.tblID = Convert.ToInt32(planid);
        ...
        #region Get WorkOutPlanIds
        public static List<int> getWorkOutPlanIds()
        {
            ...
            conn.Open();
                ...
                try
                {
                    SqlDataReader reader = SqlHelper.ExecuteReader(conn, "getWorkOutPlanIDs");
                    while (reader.Read())
                    {
